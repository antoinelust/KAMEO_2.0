<div class="modal fade" id="addClient" tabindex="-1" role="modal" aria-labelledby="modal-label" aria-hidden="true"
    style="display: none;">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
                ...
                <div class="row">
                    ...
                    <div class="row">
                        <div style="margin-top: 5px; margin-bottom: 5px;" class="col">
                            ...
                            <select title="Audience" class="form-control required" name="audience">
                        ...
                        <div style="margin-top: 5px; margin-bottom: 5px;" class="col">
                            ...
                            <select title="Type" class="form-control required" name="type">
                        ...
                        <div style="margin-top: 5px; margin-bottom: 5px;" class="col">
                            <label for="type">Aquisition</label>
                            <select title="Type" class="form-control required" name="aquisition">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-b" data-dismiss="modal">Ajouter</button>
