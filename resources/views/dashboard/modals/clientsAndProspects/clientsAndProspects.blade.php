<div class="modal fade" id="clientsAndProspects-modal" tabindex="-1" role="modal" aria-labelledby="modal-label-3" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div style="margin-bottom: 10px;">
                    <button id="addClient-btn" type="button" class="btn btn-primary btn-sm">Ajouter un client</button>
                </div>
                <div class="row">
                    <div class="col">
                        <div>
